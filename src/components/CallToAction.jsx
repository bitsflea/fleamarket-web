  ...
  return (
    <div className="bg-gradient-to-r from-[#0A192F] via-[#4C1D95] to-[#FF69B4] py-24">
      <div className="container mx-auto px-4 text-center">
        ...
        <button onClick={()=>window.location.href="https://app.bitsflea.com"} className="bg-pink-200 text-purple-900 px-10 py-4 rounded-full text-lg font-semibold hover:bg-pink-300 transition-colors shadow-lg">
          Get Started
        </button>
      </div>
    </div>

    ...
    <div className="relative min-h-screen bg-gradient-to-br from-[#0A192F] via-[#4C1D95] to-[#FF69B4] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 pt-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <button onClick={()=>window.location.href="https://app.bitsflea.com"} className="bg-pink-200 text-purple-900 px-8 py-4 rounded-full text-lg font-semibold hover:bg-pink-300 transition-colors shadow-lg">
            Get Started
          </button>
        </div>
      </div>
